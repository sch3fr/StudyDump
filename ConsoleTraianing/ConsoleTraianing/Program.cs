...
namespace ConsoleTraianing
{
    class Program
    {
        ...
        public static void InputTest() //the simplest thing ever; you enter two strings and the computer writes a sentence
        {
            Console.Clear();
            char repeat;
            do
            {
                ...
                Console.WriteLine("Press 'Y' to repeat this demo, press any other key to stop");
                repeat = char.ToLower(Console.ReadKey().KeyChar);
            } while (repeat == 'y');
            Ending();
        }
        public static void VariablesDemo() //more or less same as the InputTestm only this one uses one string and one int
        {
            Console.Clear();
            string name;
            int age;
            ...
            do { 
                ...
                while (!int.TryParse(Console.ReadLine(), out age)) //stops the users from entering anything that is not double
                {
        ...
        public static void StringManipulatoin() //makes changes to entered string and then displays 'em
        {
            Console.Clear();
            char repeat;
            do { 
        ...
        public static void Calculator() //very simple calculator, user inputs two doubles and the program outputs several calculations
        {
            Console.Clear();
            char repeat;
            do {
                ...
                while (!double.TryParse(Console.ReadLine(), out num1)) //stops the users from entering anything that is not double
                {
                    Console.WriteLine("Please enter a number :|");
                }
                ...
                while (!double.TryParse(Console.ReadLine(), out num2)) //stops the users from entering anything that is not double
                {
                    Console.WriteLine("Please enter a number :|");
                }
        ...
        public static void ArrayDemo()
        {
            ...
            char repeat;
            do {
                int[] luckyNumbers = { 7, 11, 13, 14, 42, 46, 69, 420, 888 };
                Console.WriteLine("Enter a number between 0 - 8 and I'll tell you what's your true lucky number");
                int index;
                ///TODO MAKE SURE TO LET USERS ENTER ONLY NUMBER IN RANGE 
                while (!int.TryParse(Console.ReadLine(), out index)) //stops the users from entering anything that is not int
                {
                    Console.WriteLine("Please enter a number :|");
                }
        ...
        public static void Madlibz() //basically same as InputTest, only this have much more inputs and produces a short story
        {
            Console.Clear();
            char repeat;
            do { 
        ...
        public static void Ending() //insted of writing this paragraph by hand at the end of every demo I wrote this method that makes the code a bit nicer
        {
